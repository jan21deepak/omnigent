...
def github_policy(
    *,
    ...
    :param shell_tools: Names of the shell / terminal tools whose ``command``
        ...
        shell tool of every supported harness family (``sys_os_shell``,
        ``Bash``, ``bash``, ``Shell``, ``terminal``, ``developer__shell``).
        Override this if the agent exposes shell access through a
        differently-named tool (e.g. a custom terminal); list every such tool,
        since git/gh run through any tool not listed here are not inspected by
        this policy.
        ...
        "params_schema": {
            ...
            "properties": {
                ...
                "shell_tools": {
                    ...
                    "inspected (default: sys_os_shell, Bash, bash, Shell, terminal, "
                    "developer__shell).",
                },
            },
        },
